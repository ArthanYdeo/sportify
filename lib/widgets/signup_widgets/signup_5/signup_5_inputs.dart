...
import '../../../pages/signUp/signUp6.dart';
import '../../signup_header.dart';


class SignUpInputs5 extends StatefulWidget {
  const SignUpInputs5 ({super.key});

  @override
  State<SignUpInputs5 > createState() => _SignUpInputs5State();
}

class _SignUpInputs5State extends State<SignUpInputs5 > {
  final _signUpBox = Hive.box('signUpBox');
  final _inputControllerEmailAddress = TextEditingController();
  //String? sexValue;
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            const SignUpHeader(manSpeaking: "What is your Email Address?"),
            Column(
              children: [
                Container(
                  ...
                  child: TextFormField(
                    controller: _inputControllerEmailAddress,
            ...
            Container(
              ...
              child: IconButton(
                onPressed: () {
                  setState(() {
                    String emailAddress = _inputControllerEmailAddress.text.trim();
                    if (emailAddress.isEmpty) {
                      DialogUnsuccessful(
                        headertext: "Input required!",
                        subtext: "Please input your email address!",
                        textButton: "Close",
                        callback: () {
                    ...
                    _signUpBox.put("emailAddress", emailAddress);
